  ...
  return {
    ...
    plotOptions: {
      heatmap: {
        ...
        colorScale: {
          ranges: [
            { to: 10, from: 0, name: '0-10', color: '#f3f711' },
            { to: 20, from: 11, name: '10-20', color: '#d0f30b' },
            { to: 30, from: 21, name: '20-30', color: '#030308' },
            { to: 40, from: 31, name: '30-40', color: '#ccb90b' },
            { to: 50, from: 41, name: '40-50', color: '#ddec0cb4' },
            { to: 60, from: 51, name: '50-60', color: '#010107' },
          ],
        },
      },
    },
